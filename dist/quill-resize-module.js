        ...
        ResizePlugin.prototype.positionResizerToTarget = function (el) {
            ...
            if (this.resizer !== null) {
                ...
                if (document.querySelector("#size-content")) {
                    (_a = document.querySelector("#size-content")) === null || _a === void 0 ? void 0 : _a.remove();
                }
